  ...
  return (
    ...
    >
      <View className="flex flex-1 justify-center items-center">
        ...
        <Text className="font-monstserrat-regular text-primary text-lg">
          Yours Journey, Our Ride.
        </Text>
      </View>
      <View className="flex-1">
        <View>
          <Text className="text-sm mb-1 text-gray-700 font-outfit-regular">
            Email
          </Text>
          <TextInput
        ...
        <TouchableOpacity onPress={() => router.push('/signup')}>
          <Text className="text-right text-sm text-blue-600 mb-6 font-outfit-regular">
            Forgot Password?
          </Text>
        </TouchableOpacity>
